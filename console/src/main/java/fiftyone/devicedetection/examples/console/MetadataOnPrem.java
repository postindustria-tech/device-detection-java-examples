 ...
 *
 * This example is available in full on [GitHub](https://github.com/51Degrees/device-detection-java-examples/blob/console/src/main/java/fiftyone/devicedetection/examples/console/MetadataOnPrem.java).
 *
